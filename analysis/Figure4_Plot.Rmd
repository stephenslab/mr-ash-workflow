...
subtitle  = ggdraw() + draw_label("Low-dim", fontface  = 'bold', size = 22)  
...
subtitle  = ggdraw() + draw_label("High-dim", fontface  = 'bold', size = 22)  
...
df$fit = factor(df$fit, levels =  c("Mr.ASH.init","Mr.ASH","E-NET","Lasso","Ridge",
                                    "SCAD","MCP","L0Learn",
                                    "varbvs","BayesB","B-Lasso","SuSiE","Mr.ASH.order"))
df = df[df$s != 500, ]
df$size = 0.5
df = df[df$fit %in% c("Mr.ASH","varbvs","BayesB","B-Lasso","SuSiE"),]
df$size[1:8] = 1.2
...
subtitle  = ggdraw() + draw_label("Realgenotype-design", fontface  = 'bold', size = 22)  
...
```{r figure4}
figure4  = plot_grid(fig1_1, fig1_2, fig1_3, fig1_4, fig1_5, fig1_6, ncol = 2, rel_heights = c(0.5,0.5))
...
figure4  = plot_grid(plot_grid(plot_grid(yaxis, plot_grid(figure4, xaxis,
...
ggsave("figure4_for_paper.pdf", figure4, width = 18, height = 22)
```