...
subtitle   = ggdraw() + draw_label("Signal-strength", fontface  = 'bold.italic', size = 22)  
...
subtitle   = ggdraw() + draw_label("Signal-shape-dense", fontface  = 'bold.italic', size = 22)  
...
subtitle   = ggdraw() + draw_label("Signal-shape-sparse", fontface  = 'bold.italic', size = 22)  
...
```{r figure5}
figure5  = plot_grid(fig1_7, fig1_8, fig1_9, fig1_10, ncol = 2, rel_widths = c(0.5,0.53))
