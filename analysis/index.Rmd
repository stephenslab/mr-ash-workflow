...
(3-2) Discussion: since the theory says (e.g. [Slope meets Lasso: improved oracle bounds and
optimality](https://arxiv.org/pdf/1605.08651.pdf) ) that the prediction error scales as $\sqrt{s\log(p/s)/n}$
