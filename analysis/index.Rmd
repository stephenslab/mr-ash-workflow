...
- Result: ![fig1](figure/Result1_Ridge.Rmd/fig1-1.png)
...
- Result: ![fig2](figure/Result2_Nonconvex.Rmd/fig1-1.png)
...
- Result: ![fig3](figure/Result4_Highdim.Rmd/fig1-1.png)

It shows that MR.ASH and VarBVS outperform well.

- Discussion: Since the theory says (e.g. [Slope meets Lasso: improved oracle bounds and
optimality](https://arxiv.org/pdf/1605.08651.pdf) ) that the prediction error scales as $\sqrt{s\log(p/s)/n}$, and thus we can expect that the prediction error increaese log-linearly in $p$. 
