...
library(glmnet); library(mr.ash); library(ncvreg); library(L0Learn); library(varbvs); library(mvtnorm)
standardize = FALSE
...
rho_list     = c(0.99,0.95,0.9,0.8,0.7,0.6)
for (i in 1:6) {
...
fig_main  = plot_grid(pp[[1]],pp[[2]],pp[[3]],pp[[6]], nrow = 2, rel_widths = c(0.3,0.3,0.3,0.3))
...
p            = 200
s            = 20
rho_list     = rev(c(0.99,0.95,0.9,0.6,0.3,0))
