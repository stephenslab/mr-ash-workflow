...
$$
\beta_j = \left\{ \begin{array}{ll} \sim\, h, & j \in S \\
...
```{r figure3}
figure3  = plot_grid(fig1_7, fig1_8, fig1_9, fig1_10, ncol = 2, rel_heights = c(0.5,0.55))
...
figure3  = plot_grid(plot_grid(plot_grid(yaxis,
                                                figure3, rel_widths = c(0.03,0.97), nrow = 1),
                               ncol = 1, rel_heights = c(0.05,0.95)),
                     legend, nrow = 1, rel_widths = c(0.9,0.1))
ggsave("figure3_for_paper.pdf", figure3, width = 18, height = 16)
```