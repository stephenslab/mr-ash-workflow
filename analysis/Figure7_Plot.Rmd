...
suptitle  = ggdraw() + draw_label("Group 3 (Varying n, PVE, signal shape)", fontface  = 'bold', size = 24)  
...
fig_main = ggplot(res_df) +
  ...
  theme(axis.line    = element_blank(),
        ...
        legend.position = "none", axis.title.y = element_blank()) +
  geom_hline(yintercept = baseline, color = col[1], linetype = "dashed")
suptitle  = ggdraw() + draw_label("Group 2 (Realgenotype-design)", fontface  = 'bold', size = 24)  
# subtitle  = ggdraw() + draw_label("Scenario: IndepGauss + PointNormal, n = 500, p = 200, s = 1-200, pve = 0.9", fontface  = 'bold', size = 14) 
...
fig_main = ggplot(res_df) +
  ...
  theme(axis.line    = element_blank(),
        ...
        legend.position = "none", axis.title.y = element_blank()) +
  geom_hline(yintercept = baseline, color = col[1], linetype = "dashed")
suptitle  = ggdraw() + draw_label("Group 4 (Varying-p)", fontface  = 'bold', size = 24)  
# subtitle  = ggdraw() + draw_label("Scenario: IndepGauss + PointNormal, n = 500, p = 200, s = 1-200, pve = 0.9", fontface  = 'bold', size = 14) 
...
fig_main = ggplot(res_df) +
  ...
  theme(axis.line    = element_blank(),
        ...
        legend.position = "none", axis.title.y = element_blank()) +
  geom_hline(yintercept = baseline, color = col[1], linetype = "dashed")
suptitle  = ggdraw() + draw_label("Group 1 (Varying-s)", fontface  = 'bold', size = 24) 
# subtitle  = ggdraw() + draw_label("Scenario: IndepGauss + PointNormal, n = 500, p = 200, s = 1-200, pve = 0.9", fontface  = 'bold', size = 14) 
