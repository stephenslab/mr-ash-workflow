...
fig_main  = plot_grid(p0,p1,p0, nrow = 1, rel_widths = c(0.03,0.6,0.03))
...
tdat2[[iter]] = data.frame(pred = c(pred), time = c(time), fit = rep(c("mr.ash", method_list), each = 20))
}
```
...
tdat3[[iter]] = data.frame(pred = c(pred), time = c(time), fit = rep(c("mr.ash", method_list), each = 20))
}
```
