...
method_list  = c("Mr.ASH.null","varbvs","BayesB","B-Lasso","SuSiE","E-NET","Lasso",
                 "Ridge","SCAD.2tuning","MCP.2tuning","SCAD","MCP","L0Learn","Mr.ASH")
...
for (i in 1:10) {
res_df[[i]]$pred[261:280] = newlist[[11]][[i]]$pred[21:40]
