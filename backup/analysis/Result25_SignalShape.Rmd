...
df           = data.frame()
for (i in 1:8) {
res_df[[i]]       = res_df[[i]][res_df[[i]]$fit %in% c("mr.ash","enet","lasso","ridge","scad2","mcp2","l0learn"),]
...
shape = c(19,17,24,25,9,3,11,4,5,7,8,2,1)[1:7]
...
subtitle  = ggdraw() + draw_label("Scenario: IndepGauss + PointNormal, n = 500, p = 2000, s = 20, pve = 0.5", fontface  = 'bold', size = 18) 
fig1.1    = plot_grid(title,subtitle,fig_main, ncol = 1, rel_heights = c(0.03,0.03,0.95))
```
...
df           = data.frame()
for (i in 1:8) {
res_df[[i]]       = res_df[[i]][res_df[[i]]$fit %in% c("mr.ash","varbvs","bayesb","blasso","susie"),]
res_df[[i]]$fit   = rep(method_list, each = 20)
res_df[[i]]$fit   = factor(res_df[[i]]$fit, levels = method_level)
...
title     = ggdraw() + draw_label("Prediction Error (log-scale)", fontface = 'bold', size = 20) 
subtitle  = ggdraw() + draw_label("Scenario: IndepGauss + PointNormal, n = 500, p = 2000, s = 20, pve = 0.5", fontface  = 'bold', size = 18) 
fig1.2    = plot_grid(title,subtitle,fig_main, ncol = 1, rel_heights = c(0.03,0.03,0.95))
```
...
fig_main = p1
title     = ggdraw() + draw_label("Prediction Error (log-scale)", fontface = 'bold', size = 20) 
subtitle  = ggdraw() + draw_label("Scenario: IndepGauss + PointNormal, n = 500, p = 200, s = 20, pve = 0.5", fontface  = 'bold', size = 18) 
fig2.1    = plot_grid(title,subtitle,fig_main, ncol = 1, rel_heights = c(0.03,0.03,0.95))
```
...
title     = ggdraw() + draw_label("Prediction Error (log-scale)", fontface = 'bold', size = 20) 
subtitle  = ggdraw() + draw_label("Scenario: IndepGauss + PointNormal, n = 500, p = 200, s = 20, pve = 0.5", fontface  = 'bold', size = 18) 
fig2.2    = plot_grid(title,subtitle,fig_main, ncol = 1, rel_heights = c(0.03,0.03,0.95))
```
