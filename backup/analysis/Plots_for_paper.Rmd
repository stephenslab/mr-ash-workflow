...
ggsave("figure3_paper.pdf", fig, width = 18, height = 8)
```
...
```{r fig12, fig.height=13, fig.width=15}
...
```{r fig13, fig.height=13, fig.width=15}
...
```{r fig14, fig.height=13, fig.width=15}
res_df       = readRDS("results/highdimdiffnpnew.RDS")
method_list  = c("Mr.ASH","E-NET","Lasso","Ridge","SCAD","MCP","SCAD2","MCP2","L0Learn")
df           = data.frame()
p_range      = c(20,50,100,200,500,1000,2000,5000,10000,20000)
...
```{r fig15, fig.height=13, fig.width=15}
